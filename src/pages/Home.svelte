<script>
    let heroBanner = "/img/background.jpg";
...
<header>
    <nav class="relative px-4 py-4 flex justify-between items-center bg-white">
        ...
        >
            ...
            <li>
                <a class="text-sm text-blue-600 font-bold" href="#/company">Company Information</a>
            </li>
            
            <li>
                <a class="text-sm text-gray-400 hover:text-gray-500" href="#/launch"
                    >Launch</a
                >
            </li>
            
            <li>
                <a class="text-sm text-gray-400 hover:text-gray-500" href="#/launch-pads"
                    >Launch Pads</a
                >
            </li>
        </ul>
            ...
            <div>
                <ul>
                    ...
                    <li class="mb-1">
                        <a
                            class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded"
                            href="#/company">Company Information</a
                        >
                    </li>
                    <li class="mb-1">
                        <a
                    ...
                    <li class="mb-1">
                        <a
                            class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded"
                            href="#/launch-pads">Launch Pads</a
                        >
                    </li>
                </ul>
            </div>
...
<section class="h-screen bg-[url('{heroBanner}')]">
    <h1>Banner</h1>
</section>
